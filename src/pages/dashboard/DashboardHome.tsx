  ...
  const getStatusBadge = (status: string) => {
    const statusConfig: Record<string, { icon: React.ReactNode; label: string; className: string }> = {
      confirmed: {
        ...
        label: 'Confirmé',
        className: 'bg-gradient-to-r from-emerald-600 to-emerald-700 text-white shadow-lg border-0 rounded-full px-2 py-1 text-xs font-semibold'
      },
      pending: {
      ...
      completed: {
        icon: <CheckCircle2 className="h-3 w-3" />,
        label: 'Terminé',
        className: 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg border-0 rounded-full px-2 py-1 text-xs font-semibold'
      },
      cancelled: {
        icon: <XCircle className="h-3 w-3" />,
        label: 'Annulé',
        className: 'bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-lg border-0 rounded-full px-2 py-1 text-xs font-semibold'
      },
    };
        ...
        >
          <CardContent className="p-4 lg:p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-14 h-14 bg-gradient-to-br from-slate-600 to-slate-700 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all">
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-slate-50/30 hover:shadow-xl transition-all duration-300 cursor-pointer group transform hover:scale-105">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-14 h-14 bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all">
