...
import { CheckCircle, ArrowRight, Users, Play, Eye } from 'lucide-react';
...
export default function OphtalmologuePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Logiciel Ophtalmologue Maroc | Gestion Cabinet Ophtalmologie - Docliq</title>
        <meta name="description" content="Logiciel pour ophtalmologues marocains. Dossiers vision, prescriptions lunettes, suivi glaucome. Moderne et intuitif. 340+ ophtalmologues utilisent Docliq." />
        <meta name="keywords" content="logiciel ophtalmologue maroc, gestion cabinet ophtalmologie, logiciel ophtalmologie maroc" />
        <link rel="canonical" href="https://docliq.ma/logiciel-ophtalmologue-maroc" />
      </Helmet>
            ...
            <div className="max-w-[1600px] mx-auto text-center">
              <div className="space-y-6 md:space-y-8">
                <Badge className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-md text-docliq-blue border border-docliq-blue/20 rounded-full px-4 md:px-5 lg:px-6 py-2 lg:py-2.5 shadow-lg text-sm md:text-base">
                  <Eye className="w-4 h-4" /><span className="font-semibold">340+ ophtalmologues utilisent Docliq</span>
                </Badge>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold text-docliq-text leading-[1.1] tracking-tight px-4 md:px-0">
                  Logiciel pour ophtalmologue au Maroc
                  <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-docliq-blue via-docliq-purple to-docliq-turquoise">Vision et prescriptions optiques.</span>
                </h1>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-[#4A4A4A] leading-relaxed font-normal max-w-4xl mx-auto px-4 md:px-6 lg:px-0">
                  Gestion complète pour cabinets d'ophtalmologie avec dossiers vision et prescriptions lunettes.
                </p>
                <DemoPopup onDashboardClick={handleDashboardDemo} onBookingClick={handleBookingDemo}>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 shadow-lg border border-white/50">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-docliq-text mb-6 md:mb-8">
                  Solution ophtalmologie pour praticiens marocains
                </h2>
                <div className="space-y-6 text-base md:text-lg text-[#4A4A4A] leading-relaxed">
                  <p><strong>Docliq</strong> propose une solution complète pour ophtalmologues au Maroc. Gérez vos consultations ophtalmologiques, stockez les mesures d'acuité visuelle, générez des prescriptions optiques et suivez les pathologies oculaires avec un logiciel moderne et sécurisé.</p>
                  <h3 className="text-xl md:text-2xl font-bold text-docliq-text mt-8 mb-4">Fonctionnalités ophtalmologie</h3>
                  <ul className="space-y-3 ml-6">
                    <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" /><span><strong>Dossiers vision complets</strong> : Historique acuité visuelle, réfraction, examens complémentaires</span></li>
                    <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" /><span><strong>Prescriptions optiques</strong> : Génération automatique ordonnances lunettes et lentilles</span></li>
                    <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" /><span><strong>Suivi glaucome et cataracte</strong> : Monitoring pression intraoculaire et évolution pathologies</span></li>
                    <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" /><span><strong>Fond d'œil numérique</strong> : Stockage et comparaison images rétiniennes</span></li>
                  </ul>
                  <p>Rejoignez <strong>340+ ophtalmologues marocains</strong> qui modernisent leur pratique avec Docliq. Essai gratuit 7 jours.</p>
                </div>
