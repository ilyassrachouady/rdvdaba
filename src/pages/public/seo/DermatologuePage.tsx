...
import { CheckCircle, ArrowRight, Users, Play } from 'lucide-react';
import { Helmet } from 'react-helmet-async';

export default function DermatologuePage() {
  const navigate = useNavigate();
  const [patientCount] = useState(420);
  ...
  return (
    <>
      <Helmet>
        <title>Logiciel Dermatologue Maroc | Gestion Cabinet Dermatologie - Docliq</title>
        <meta name="description" content="Logiciel spécialisé pour dermatologues au Maroc. Gestion photos avant/après, suivi traitements dermatologiques, dossiers patients. 420+ dermatologues utilisent Docliq." />
        <meta name="keywords" content="logiciel dermatologue maroc, logiciel cabinet dermatologie, gestion dermatologie maroc" />
        <link rel="canonical" href="https://docliq.ma/logiciel-dermatologue-maroc" />
      </Helmet>
          ...
          <div className="max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8 xl:px-12">
            <div className="flex items-center justify-between h-16 md:h-18 lg:h-20">
              ...
              <DemoPopup onDashboardClick={handleDashboardDemo} onBookingClick={handleBookingDemo}>
                <Button className="bg-gradient-to-r from-docliq-blue to-docliq-purple text-white rounded-lg md:rounded-xl h-10 md:h-11 lg:h-12 px-4 md:px-5 lg:px-6 font-semibold shadow-lg text-sm md:text-base lg:text-lg">
            ...
            <div className="max-w-[1600px] mx-auto text-center">
              <div className="space-y-6 md:space-y-8">
                <Badge className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-md text-docliq-blue border border-docliq-blue/20 rounded-full px-4 md:px-5 lg:px-6 py-2 lg:py-2.5 shadow-lg text-sm md:text-base">
                  ...
                  <span className="font-semibold">{patientCount}+ dermatologues utilisent Docliq</span>
                </Badge>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold text-docliq-text leading-[1.1] tracking-tight px-4 md:px-0">
                  Logiciel pour dermatologue au Maroc
                  <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-docliq-blue via-docliq-purple to-docliq-turquoise">Gestion photos et traitements.</span>
                </h1>
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-[#4A4A4A] leading-relaxed font-normal max-w-4xl mx-auto px-4 md:px-6 lg:px-0">
                  Solution complète pour votre cabinet de dermatologie avec gestion photos avant/après et suivi traitements.
                </p>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 shadow-lg border border-white/50">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-docliq-text mb-6 md:mb-8">
                  Pourquoi les dermatologues marocains choisissent Docliq
                </h2>
                
                <div className="space-y-6 text-base md:text-lg text-[#4A4A4A] leading-relaxed">
                  <p>
                    <strong>Docliq</strong> est le logiciel de gestion spécialisé pour cabinets de dermatologie au Maroc. Gérez vos consultations dermatologiques, stockez et comparez des photos de patients, suivez l'évolution des traitements, et optimisez votre planning avec une solution moderne adaptée à votre spécialité.
                  </p>

                  <h3 className="text-xl md:text-2xl font-bold text-docliq-text mt-8 mb-4">
                    Fonctionnalités spécifiques dermatologie
                  </h3>

                  <ul className="space-y-3 ml-6">
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" />
                      <span><strong>Gestion photos dermatologiques</strong> : Stockage sécurisé photos avant/après avec comparaison chronologique</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" />
                      <span><strong>Suivi traitements acné et esthétiques</strong> : Protocoles personnalisés avec alertes de suivi</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" />
                      <span><strong>Dermatoscopie numérique</strong> : Intégration images haute résolution pour diagnostics précis</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" />
                      <span><strong>Plans de traitement personnalisés</strong> : Création et suivi de protocoles dermatologiques complexes</span>
                    </li>
                  </ul>

                  <p>
                    Plus de <strong>420 dermatologues au Maroc</strong> utilisent Docliq quotidiennement pour gérer leur pratique. Solution cloud accessible partout, conforme RGPD, avec support francophone dédié. Essai gratuit de 7 jours sans engagement.
                  </p>
                </div>
