...
export default function PediatrePage() {
  ...
  const [patientCount] = useState(620);
  ...
  return (
    <>
      <Helmet>
        <title>Logiciel Pédiatre Maroc | Gestion Cabinet Pédiatrique - Docliq</title>
        <meta name="description" content="Logiciel pédiatrique au Maroc. Courbes de croissance, carnet de vaccination, suivi développement enfant. 620+ pédiatres utilisent Docliq. Essai gratuit 7 jours." />
        <meta name="keywords" content="logiciel pédiatre maroc, logiciel cabinet pédiatrique, gestion pédiatrie maroc" />
        <link rel="canonical" href="https://docliq.ma/logiciel-pediatre-maroc" />
      </Helmet>
            ...
            <div className="max-w-[1600px] mx-auto text-center">
              <div className="space-y-6 md:space-y-8">
                <Badge className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-md text-docliq-blue border border-docliq-blue/20 rounded-full px-4 md:px-5 lg:px-6 py-2 lg:py-2.5 shadow-lg text-sm md:text-base">
                  ...
                  <span className="font-semibold">{patientCount}+ pédiatres marocains</span>
                </Badge>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold text-docliq-text leading-[1.1] tracking-tight px-4 md:px-0">
                  Logiciel pour pédiatre au Maroc
                  <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-docliq-blue via-docliq-purple to-docliq-turquoise">Suivi enfants et vaccination.</span>
                </h1>
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-[#4A4A4A] leading-relaxed font-normal max-w-4xl mx-auto px-4 md:px-6 lg:px-0">
                  Solution complète pour cabinets pédiatriques avec courbes de croissance et carnets de vaccination.
                </p>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 shadow-lg border border-white/50">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-docliq-text mb-6 md:mb-8">
                  Logiciel pédiatrique adapté aux pédiatres marocains
                </h2>
                
                <div className="space-y-6 text-base md:text-lg text-[#4A4A4A] leading-relaxed">
                  <p>
                    <strong>Docliq</strong> est le logiciel de référence pour les pédiatres au Maroc. Suivez la croissance et le développement de vos jeunes patients avec des outils spécialisés : courbes de croissance automatiques, carnets de vaccination intégrés, et suivi personnalisé pour chaque enfant.
                  </p>

                  <h3 className="text-xl md:text-2xl font-bold text-docliq-text mt-8 mb-4">
                    Fonctionnalités pédiatriques spécialisées
                  </h3>

                  <ul className="space-y-3 ml-6">
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" />
                      <span><strong>Courbes de croissance</strong> : Graphiques automatiques poids/taille selon standards OMS</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" />
                      <span><strong>Carnet de vaccination</strong> : Suivi vaccinal complet avec rappels automatiques</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" />
                      <span><strong>Suivi développement</strong> : Étapes développement psychomoteur et alertes si retard</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-docliq-success shrink-0 mt-1" />
                      <span><strong>Dossier famille</strong> : Gestion simplifiée des fratries et historique familial</span>
                    </li>
                  </ul>

                  <p>
                    Plus de <strong>620 pédiatres au Maroc</strong> font confiance à Docliq pour moderniser leur pratique. Interface intuitive, formation incluse, essai gratuit 7 jours.
                  </p>
                </div>
